<h2><a href="https://leetcode.com/problems/number-of-prefix-connected-groups">4137. Number of Prefix Connected Groups</a></h2><h3>Medium</h3><hr><p>You are given an array of strings <code>words</code> and an integer <code>k</code>.</p>
...
<p>Two words <code>a</code> and <code>b</code> at <strong>distinct indices</strong> are <strong>prefix-connected</strong> if <code>a[0..k-1] == b[0..k-1]</code>.</p>
...
<ul>
	...
	<li>A <strong>prefix</strong> of a string is a substring that starts from the beginning of the string and extends to any point within it.</li>
</ul>
